# Script prepares the virtual environment for working with ansible. Run the script in the directory with a command, then enter a line into the terminal and you're done. 
